...
class Menu:
    def __init__(self, screen):
        ...
        self.title_font = pygame.font.SysFont("Arial", 60)  # Pour le titre
        self.subtitle_font = pygame.font.SysFont("Arial", 20)  # Pour le sous-titre
        self.subtitle_text = "Un jeu de stratégie magique fait par Abdoulaye et Shelly !"  # <-- Ici tu peux modifier le sous-titre
        self.buttons = [
    ...
    def draw(self):
        self.screen.fill((0, 105, 148))  # Bleu océan
        ...
        self.screen.blit(subtitle_surf, (10, self.screen.get_height() - 30))  # position bas à gauche
