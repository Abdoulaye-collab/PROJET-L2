...
%\AddToShipoutPicture*{\EtiquetteThese}
  ...
  \centering
    ...
    \vspace{1cm}
      {\Large Licence MIASHS parcours MIAGE deuxième année}\\
    \vspace{1cm}
      {\huge 
      	{\bfseries Rapport de projet Algorithme et Programmation}\\
    \vspace{0.5cm}}
      	$\ $\\
    \vspace{1cm}
   		\includegraphics[width=0.75\textwidth]{images/banner.png}\\
    %\vspace{1cm}
    ...
    %\vfill
	\begin{tabular}{ll} % "ll" veut dire 2 colonnes alignées à gauche
        \vspace{0.2cm} & \\ % Petit espace
        \textbf{Enseignant référent :} & M. Delbot \\
        \\[0.3cm]
        \textbf{Auteurs :} & 42013418 Rakotoarivelo Shelly-Linda \\
                          & 43012479 Ly Abdoulaye
    \end{tabular}
    
    \vspace{1cm} % Un petit espace pour aérer
    \textbf{Code source complet :} \\
    \url{https://github.com/Abdoulaye-collab/PROJET-L2}
